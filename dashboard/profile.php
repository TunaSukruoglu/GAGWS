        ...
        if (isset($_POST['update_profile'])) {
            ...
            if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK) {
                ...
                if (move_uploaded_file($_FILES['profile_image']['tmp_name'], $upload_path)) {
                    ...
                    $profile_image_path = 'images/profiles/' . $new_filename;
                    
                    // DEBUG LOG
                    error_log("Profile image uploaded successfully: $profile_image_path");
                } else {
                    throw new Exception("Profil resmi yüklenirken hata oluştu. Upload path: $upload_path");
                }
            }
            ...
            if ($update_query->execute()) {
                ...
                $success = "Profil bilgileri başarıyla güncellendi!" . (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK ? " Profil resmi: $profile_image_path" : "");
                    ...
                    <div class="col-md-auto">
                        <div class="profile-avatar">
                            <div class="avatar-container">
                                ...
                                ?>
                                    <img src="/profile-image.php?image=<?= htmlspecialchars($image_filename) ?>" alt="Profil Resmi" class="avatar-image">
                                <?php else: ?>
